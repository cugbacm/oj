 ...
 #rank_list.ParseFromString(contest_rank_list.rank_list_proto_str.encode("utf-8"))
  ...
  for rank in rank_list.rank:
    ...
    for problem_ in rank.problem:
      rank_list_dic[rank.userID][problem_.problemID] = {}
      rank_list_dic[rank.userID][problem_.problemID]['acindex'] = problem_.acindex
      rank_list_dic[rank.userID][problem_.problemID]['totalindex'] = problem_.totalindex
      rank_list_dic[rank.userID][problem_.problemID]['time'] = problem_.time

      for submit_ in problem_.submit:
        rank_list_dic[rank.userID][problem_.problemID][submit_.runID] = {}
